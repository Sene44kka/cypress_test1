...
describe('Facebook signin signup tests', () =>{
    ...
    it('FB title page', ()=>{
        cy.get('title').invoke('text').should('equal', 'Facebook — Выполните вход или зарегистрируйтесь');
    });
    ...
    it('FB Create New Account Button test', ()=>{
        ...
        cy.get('div').contains('Регистрация').invoke('text').should('equal', 'Регистрация');
